...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _FieldStyle = __webpack_require__(13);

	var _FieldStyle2 = _interopRequireDefault(_FieldStyle);

	var _formValidators = __webpack_require__(7);
	...
	var Field = function (_Component) {
	  ...
	  _createClass(Field, [{
	    ...
	    value: function checkForValidation(value) {
	      var validators = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.props.validators;
	    ...
	    value: function setFieldState(value) {
	      ...
	      this.setState({ value: value, valid: valid, error: error, touched: touched }, callback);
	    }
	  }, {
	    ...
	    value: function onChangeHandler(event) {
	      ...
	      this.setFieldState(this.props.valueAccessor ? this.props.valueAccessor(event) : this.defaultValueAccessors(event), true, this.props.validators, function () {
	        return _this3.props.onChange && _this3.props.onChange(event);
	      });
	    }
	  }, {
	        ...
	        radio: this.props.options && this.props.options.map(function (o) {
	          return _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { type: 'radio',
	              ...
	              ref: _this4.props.name,
	              value: o.value,
	              name: _this4.props.name,
	              checked: _this4.state.value === o.value,
	              selected: _this4.state.value === o.value,
	...
	Field.propTypes = {
	  ...
	  value: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.bool, _propTypes2.default.number]),
	  defaultValue: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.bool, _propTypes2.default.number]),
	  ...
	  helpStyle: _propTypes2.default.object,
	  controlStyle: _propTypes2.default.object,
	  labelStyle: _propTypes2.default.object,
	  placeholder: _propTypes2.default.string,
	  inline: _propTypes2.default.bool,
	  forceValidate: _propTypes2.default.bool,
	  valueAccessor: _propTypes2.default.func,
	  optimize: _propTypes2.default.bool
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Form.propTypes = {
	  ...
	  onDemand: _propTypes2.default.bool
	};
